...
# export 'BEARER_TOKEN'='hide'
webhook_url_35P_tweet = 'Discord webhooks URL here'
webhook_url_35P_Art = 'Discord webhooks URL here'
webhook_url_Admin_twitter = 'Discord webhooks URL here'
